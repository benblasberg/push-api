...
is intelligent because it knows which servers are already consuming messages from the topic that the client request wants to stream. If knows of a server that
